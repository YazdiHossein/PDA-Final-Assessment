...
An overview of some financial data scraping techniques using SQL databases. baosted by Clint Howard on April 29, 2017" */
CREATE TABLE ASX200 (
    PRIMARY KEY (code),
    KEY (code),
    Code VARCHAR(10),
...
SELECT TIMESTAMPDIFF(DAY, Date, CURDATE()) AS TD, Code, Company FROM asx200;

/* We need to have all companies with date of 1 April 2016, with market cap between 400 million and 1.5 billion, Weight_Percentage between 20 and 80 percent
